    ...
    let maps = [
            {
                parent: '#map1',
                id: "map",
                position: [window.map_dot1, window.map_dot2],
                zoom: 16,
                balloonContentHeader: 'Эксперт Самара',
                balloonContentBody: '<a href="tel:+78469777779" class="map-phone phone">☎️ 8 (846) 9 77777 9</a><br></br>\
                    '+window.addr+'<br>\
                    <a href="https://yandex.ru/maps/51/samara/?from=api-maps&ll=50.151100%2C53.184600&mode=routes&origin=jsapi_2_1_77&rtext=~53.184600%2C50.151100&rtt=auto&ruri=~&z=16"  target="_blank" class="map-btn btn arrow"><span>Проложить маршрут</span></a>',
                balloonContentFooter: 'Пн-сб с 9:00 до 21:00, вс. 9:00 до 19:00',
                hintContent: 'Эксперт Самара'
            },
        ],
